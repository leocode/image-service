...
describe('ImageService', () => {
  ...
  describe('#resize', () => {
    it('should resize passed image', async () => {
      ...
      const resizedImageMetadata = await getImageDimensions(resizedImage);
  ...
  describe('#crop', () => {
    it('should crop passed image', async () => {
      ...
      const croppedImageMetadata = await getImageDimensions(croppedImage);
  ...
  describe('#metadata', () => {
    it('should retrieve metadata of passed file', async () => {
      const image = await getTestImage();
      const expectedMetadata = await sharp(
        await getTestImageBuffer(),
      ).metadata();
